...
describe BettingStrategy::TakeAllForecastingPatternsWithoutDuplication, type: :model do
  ...
  describe '#bet' do
    ...
    context 'when recommend odds are present' do
      context 'when have not bet yet' do
        ...
        it 'creates bettings of all forecasting patterns without duplicated betting numbers' do
          expect { subject }.to change { Betting.count }.by(2)
