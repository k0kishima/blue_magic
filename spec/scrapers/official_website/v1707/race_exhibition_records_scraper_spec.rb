    ...
    context 'ファイルがセットされているとき' do
      ...
      context 'レース直前情報ページのファイルが引数として渡されたとき' do
        ...
        context '展示に参加しなかった艇が存在するとき' do
          ...
          it '不参加の艇も含めて取得できること' do
            expect(subject).to contain_exactly(
              { :date => Date.new(2017, 6, 25),
                :stadium_tel_code => 6,
                :race_number => 10,
                :pit_number => 1,
                :racer_registration_number => 3822,
              ...
              { :date => Date.new(2017, 6, 25),
                ...
                :race_number => 10,
                :pit_number => 2,
                :racer_registration_number => 3346,
              ...
              { :date => Date.new(2017, 6, 25),
                ...
                :race_number => 10,
                :pit_number => 3,
                :racer_registration_number => 4254,
              ...
              { :date => Date.new(2017, 6, 25),
                ...
                :race_number => 10,
                :pit_number => 4,
                :racer_registration_number => 4793,
              ...
              { :date => Date.new(2017, 6, 25),
                ...
                :race_number => 10,
                :pit_number => 6,
                :racer_registration_number => 3425,
                :exhibition_time => 6.73,
                :start_course => 5,
                :start_time => 0.16,
                :is_flying => false,
