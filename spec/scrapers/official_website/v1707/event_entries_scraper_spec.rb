      ...
      context '前検情報ページのファイルが引数として渡されたとき' do
        ...
        context 'ダブル開催の時（チャレンジカップもしくはグランプリ)' do
          describe 'グランプリでのスクレイピング' do
            let(:file_path) {
              "#{Rails.root}/spec/fixtures/files/official_website/v1707/event_entry/2019_12_18_12#.html"
            }
          ...
          describe 'チャレンジカップでのスクレイピング' do
            let(:file_path) {
              "#{Rails.root}/spec/fixtures/files/official_website/v1707/event_entry/2019_11_19_01#.html"
            }
