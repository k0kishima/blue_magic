# HACK: 使い捨てのコードなので汚くても動けばいいというスタンスで実装
namespace :once do
  namespace :official_website do
    namespace :data_import do
      ...
      # e.g.
      # docker-compose exec app bundle exec rake once:official_website:data_import:fetch_specified_contents_data_of_a_day DATE='2021-04-30' CONTENT_MODEL_NAME='OfficialWebsite::RaceResultPage' INTERVAL=0
      ...
      # HACK: 無理やり一括インポートで処理するようにした結果特にここが酷く汚くなっている
