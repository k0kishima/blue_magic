...
# 2018	17042000	21294100	4252100	124.9507
# 2019	17044400	19259002	2214602	112.9931
# 2020	17802000	21067724	3265724	118.3447

# monthly
# 2018	1	1248500	2279075	1030575	182.5451
# 2019	1	1126200	1559617	433417	138.4849
# 2020	1	1124300	1565014	440714	139.1990
# 2018	2	3232300	4613625	1381325	142.7350
# 2019	2	3263000	3349086	86086	102.6382
# 2020	2	2638100	3419541	781441	129.6214
# 2018	3	2079000	2378213	299213	114.3922
# 2019	3	1871400	1632395	-239005	87.2285
# 2020	3	1349900	1983759	633859	146.9560
# 2018	4	1862400	2806053	943653	150.6687
# 2019	4	2805000	2541314	-263686	90.5994
# 2020	4	3667500	3578123	-89377	97.5630
# 2018	5	8054600	7628035	-426565	94.7041
# 2019	5	7082500	8189400	1106900	115.6287
# 2020	5	6878100	8508595	1630495	123.7056
# 2018	6	289900	794945	505045	274.2135
# 2019	6	361300	397613	36313	110.0507
# 2020	6	1085400	1220663	135263	112.4620
# 2018	7	275300	794154	518854	288.4686
# 2019	7	535000	1589577	1054577	297.1172
# 2020	7	1058700	792029	-266671	74.8115
ForecastingPattern.upsert_all(
  [
    ...
    {
      id: 2,
      name: '前付けでの波乱狙い (V1での logn_shot_5 改善版)',
      race_select_condition: {
        and: [
          {
            '<': [
    ...
    },
    {
      ...
      race_select_condition: {
        and: [
          ...
          {
            '<': [
              { item: :itself, attribute: :air_temperature_when_exhibition },
              { item: :literal, value: 30 },
            ]
          },
          {
            '<': [
    ...
    {
      id: 5,
      name: '強風での波乱狙い (V2の long_shot 改善版)',
      race_select_condition: {
        and: [
          # レース絞り込み共通条件
          {
          ...
          },
          {
            '!=': [
              { item: :itself, attribute: :stadium_tel_code },
              { item: :literal, value: 22 },
            ]
          },
          {
            '!=': [
              { item: :itself, attribute: :stadium_tel_code },
              { item: :literal, value: 24 },
            ]
          },
          {
            '==': [
    ...
    },
    {
      ...
      race_select_condition: {
        and: [
          ...
          {
            '==': [
              { item: :pit_number_3, attribute: :flying_count_in_current_rating_term },
              { item: :literal, value: 0 }
            ]
          },
          {
            ...
            or: [
              {
                '==': [
                  { item: :itself, attribute: :series_grade },
                  { item: :literal, value: 'SG' },
                ]
              },
              {
                '==': [
                  { item: :itself, attribute: :series_grade },
                  { item: :literal, value: 'G1' },
                ]
              },
            ],
          },
