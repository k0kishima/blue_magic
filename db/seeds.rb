...
Kpi.upsert_all(
  [
    ...
    { id: 23, type: "RacerDisqualificationKpi", entry_object_class_name: "RaceEntry", name: "今期失格回数合計", description: "", attribute_name: "disqualification_total_in_current_rating_term", created_at: Time.zone.now, updated_at: Time.zone.now, },
    { id: 24, type: "RacerDisqualificationKpi", entry_object_class_name: "RaceEntry", name: "今期F回数", description: "", attribute_name: "flying_count_in_current_rating_term", created_at: Time.zone.now, updated_at: Time.zone.now, },
    { id: 25, type: "RacerDisqualificationKpi", entry_object_class_name: "RaceEntry", name: "今期L回数", description: "", attribute_name: "lateness_count_in_current_rating_term", created_at: Time.zone.now, updated_at: Time.zone.now, },
    ...
    { id: 36, type: "RacerStartTimeKpi", entry_object_class_name: "RaceEntry", name: "今期平均ST", description: "", attribute_name: "start_time_average_in_current_rating_term", created_at: Time.zone.now, updated_at: Time.zone.now, },
    { id: 37, type: "RacerStartTimeKpi", entry_object_class_name: "RaceEntry", name: "今期ST標準偏差", description: "", attribute_name: "start_time_stdev_in_current_rating_term", created_at: Time.zone.now, updated_at: Time.zone.now, },
