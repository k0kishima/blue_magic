...
Kpi.upsert_all(
  [
    ...
    { id: 29, type: "AttributionalKpi", entry_object_class_name: "RaceEntry", name: "1着率(全場)", description: "集計対象を全場とした場合の1着率", attribute_name: "first_place_rate_on_start_course_in_exhibition", created_at: Time.zone.now, updated_at: Time.zone.now, },
    { id: 30, type: "AttributionalKpi", entry_object_class_name: "RaceEntry", name: "2着率(全場)", description: "集計対象を全場とした場合の2着率", attribute_name: "second_place_rate_on_start_course_in_exhibition", created_at: Time.zone.now, updated_at: Time.zone.now, },
    { id: 31, type: "AttributionalKpi", entry_object_class_name: "RaceEntry", name: "3着率(全場)", description: "集計対象を全場とした場合の3着率", attribute_name: "third_place_rate_on_start_course_in_exhibition", created_at: Time.zone.now, updated_at: Time.zone.now, },
